...
tests = []
tests.append({'name': 'test-wrong-arguments-1', 'title': 'Empty arguments', 'exit_code': 1, 'args': [], 'stdin': None, 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-wrong-arguments-2', 'title': 'Too few arguments 1', 'exit_code': 1, 'args': ['foo'], 'stdin': None, 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-wrong-arguments-3', 'title': 'Too few arguments 2', 'exit_code': 1, 'args': ['foo', '-i'], 'stdin': None, 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-wrong-arguments-4', 'title': 'Insensitive flag specified twice', 'exit_code': 1, 'args': ['foo', 'bar', '-i', '-i'], 'stdin': None, 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-wrong-arguments-5', 'title': 'Output path specified twice', 'exit_code': 1, 'args': ['foo', 'bar', '-o', 'x', '-o', 'y'], 'stdin': None, 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-wrong-arguments-6', 'title': 'Output path missing value', 'exit_code': 1, 'args': ['foo', 'bar', '-o'], 'stdin': None, 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-wrong-arguments-7', 'title': 'Too many arguments', 'exit_code': 1, 'args': ['foo', 'bar', 'baz'], 'stdin': None, 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-wrong-arguments-8', 'title': 'Only flags', 'exit_code': 1, 'args': ['-o', 'foo', '-i'], 'stdin': None, 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-simple', 'title': 'Simple', 'exit_code': 0, 'args': ['input.txt', 'a'], 'stdin': None, 'stdout': 'stdout', 'stderr': None, 'files_in': ['input.txt'], 'files_out': []})
tests.append({'name': 'test-longer-needle', 'title': 'Longer needle', 'exit_code': 0, 'args': ['input.txt', 'aAa'], 'stdin': None, 'stdout': 'stdout', 'stderr': None, 'files_in': ['input.txt'], 'files_out': []})
tests.append({'name': 'test-case-insensitive-1', 'title': 'Case insensitive 1', 'exit_code': 0, 'args': ['-i', 'in.txt', 'abX'], 'stdin': None, 'stdout': 'stdout', 'stderr': None, 'files_in': ['in.txt'], 'files_out': []})
tests.append({'name': 'test-case-insensitive-2', 'title': 'Case insensitive 2', 'exit_code': 0, 'args': ['in.txt', '-i', 'Acx'], 'stdin': None, 'stdout': 'stdout', 'stderr': None, 'files_in': ['in.txt'], 'files_out': []})
tests.append({'name': 'test-case-insensitive-3', 'title': 'Case insensitive 3', 'exit_code': 0, 'args': ['in.txt', 'addx', '-i'], 'stdin': None, 'stdout': 'stdout', 'stderr': None, 'files_in': ['in.txt'], 'files_out': []})
tests.append({'name': 'test-output-file', 'title': 'Output file', 'exit_code': 0, 'args': ['file.txt', 'foobar', '-o', 'output.txt'], 'stdin': None, 'stdout': None, 'stderr': None, 'files_in': ['file.txt'], 'files_out': ['output.txt']})
tests.append({'name': 'test-output-file-case-insensitive-1', 'title': 'Output file + case insensitive 1', 'exit_code': 0, 'args': ['in.txt', 'baZ', '-i', '-o', 'output.txt'], 'stdin': None, 'stdout': None, 'stderr': None, 'files_in': ['in.txt'], 'files_out': ['output.txt']})
tests.append({'name': 'test-output-file-case-insensitive-2', 'title': 'Output file + case insensitive 2', 'exit_code': 0, 'args': ['in.txt', 'Baz', '-o', 'output.txt', '-i'], 'stdin': None, 'stdout': None, 'stderr': None, 'files_in': ['in.txt'], 'files_out': ['output.txt']})
tests.append({'name': 'test-output-file-case-insensitive-3', 'title': 'Output file + case insensitive 3', 'exit_code': 0, 'args': ['-i', 'in.txt', '-o', 'output.txt', 'BAZ'], 'stdin': None, 'stdout': None, 'stderr': None, 'files_in': ['in.txt'], 'files_out': ['output.txt']})
