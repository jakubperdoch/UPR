...
tests = []
tests.append({'name': 'test-simple', 'title': 'Simple', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-stuck', 'title': 'Stuck', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-through-walls', 'title': 'There and back again', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-early-exit', 'title': 'Early exit', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-square', 'title': 'Square', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-parallel-h', 'title': 'H in parallel', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-parallel-x', 'title': 'X marks the spot', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-quantum-entanglement', 'title': 'Quantum entanglement', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-too-many-turtles', 'title': 'Too many parallel universes', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-triple-fill', 'title': 'Triple fill painters', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-override', 'title': 'Override', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-upr', 'title': 'My favourite subject', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
