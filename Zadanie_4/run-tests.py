...
tests = []
tests.append({'name': 'test-invalid-mode', 'title': 'Invalid histogram mode', 'exit_code': 1, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-no-elems-hor', 'title': 'No elements horizontal', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-simple', 'title': 'Simple', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-outside-range', 'title': 'Numbers outside of range', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-cent', 'title': 'Spanning a hundred', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-large-range', 'title': 'Big numbers', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-complex-hor', 'title': 'Complex horizontal', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-big', 'title': 'Big input', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-no-elems-vert', 'title': 'No elements vertical', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-complex-vert', 'title': 'Complex vertical', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
