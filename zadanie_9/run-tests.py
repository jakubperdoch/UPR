...
tests = []
tests.append({'name': 'test-wrong-arguments', 'title': 'Wrong arguments', 'exit_code': 1, 'args': ['foo'], 'stdin': None, 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-missing-input', 'title': 'Missing input', 'exit_code': 1, 'args': ['/a/b/c.tga', 'out.tga', 'template/font'], 'stdin': None, 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-1', 'title': 'Meme 1', 'exit_code': 0, 'args': ['images/img1.tga', 'out-1.tga', 'font-images'], 'stdin': 'stdin', 'stdout': None, 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-2', 'title': 'Meme 2', 'exit_code': 0, 'args': ['images/img2.tga', 'out-2.tga', 'font-images'], 'stdin': 'stdin', 'stdout': None, 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-3', 'title': 'Meme 3 (no text)', 'exit_code': 0, 'args': ['images/img1.tga', 'out-3.tga', 'font-images'], 'stdin': 'stdin', 'stdout': None, 'stderr': None, 'files_in': [], 'files_out': []})
