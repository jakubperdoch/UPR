...
tests = []
tests.append({'name': 'test-empty', 'title': 'No input', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-spaces', 'title': 'Nasty spaces', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-max-chars', 'title': 'Boundary conditions', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-consecutive', 'title': 'Consecutive chars', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-simple', 'title': 'Simple', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-medium', 'title': 'Medium', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-large', 'title': 'Large', 'exit_code': 0, 'args': [], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
